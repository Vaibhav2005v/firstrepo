...
#tuple : - these are give by '()' instead of '[]' used for list
#tuple are immutable
#to make a tuple to set use curly brackets
...
# set 
marks = {95, 98, 97, 97, 97}
print(marks) #set will cut down extra values in a given curly brackets as it is the function of set to combine same item 



#dictionary
#used to store multiple details
...
#functions
#consists of 1.) in-built function; 2.)module function; 3.)user-defined functions
#in-built function include functions like int,float,print etc
#module function include function and module like math function triggered by - import math; which include functions like sqrt: - square root
